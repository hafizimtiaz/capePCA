...
save('mnist_vs_delta_ver2', 'delta_all', 'epsilon', 'site_members', 'en_pool_ndp', 'en_pool_dp', 'en_dist_hafiz_ndp', 'en_dist_hafiz_dp', 'en_dist_hafiz_dp_ver2', 'en_dist_djica_ndp', 'en_dist_djica_dp', 'en_loc_hafiz_ndp', 'en_loc_hafiz_dp', 'en_loc_djica_ndp', 'en_loc_djica_dp')
%% plot
FS = 24;
...
title('MNIST data (\epsilon=2, S = 10, N_s = 1k)','FontSize',FS,'FontWeight','bold')
